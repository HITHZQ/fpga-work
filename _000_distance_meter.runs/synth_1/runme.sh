...
HD_PWD='E:/FPGA_project/Xilinx_Artix7/_000_distance_meter/_000_distance_meter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log distance_meter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source distance_meter.tcl
